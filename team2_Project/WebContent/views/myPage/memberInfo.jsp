                                        ...
                                        <div id="member_info">
                                            <form action="<%= contextPath%>/update.me" method="post">
                                                <table id="member_table">
                                                    ...
                                                    <tr>
                                                        <th>전화번호</th>
                                                        <td><input type="tel" class="form-control mb-2 mr-sm-2"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="submit" class="btn btn-primary mb-2">새로운
                                                                배송지</button>
                                                            <button type="submit" class="btn btn-primary mb-2">배송지
                                                                목록</button>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <th>마케팅 선택 동의 사항</th>
                                                        <td>
                                                            <input type="checkbox" name="adCheck" id="email"
                                                                value="이메일">
                                                            <label for="email">이메일</label>
                                                            <br>
                                                            <input type="checkbox" name="adCheck" id="text" value="문자">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><button type="reset"
                                                                class="btn btn-primary mb-2">취소하기</button>
                                                            <button type="submit"
