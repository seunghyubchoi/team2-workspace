			...
			<body>
				<%@include file="../common/menubar.jsp" %>
					<% String memId=loginUser.getMemId(); String memName=loginUser.getMemName(); String
						...
						loginUser.getBirthday()); String phone=loginUser.getPhone(); String
						email=(loginUser.getEmail()==null ? "" : loginUser.getEmail()); String
						instaId=(loginUser.getInstaId()==null ? "" : loginUser.getInstaId()); String
						adCheck=(loginUser.getAdCheck()==null ? "" : loginUser.getAdCheck()); Location
						defaultLocation=(Location) session.getAttribute("defaultLocation"); String
						locName=defaultLocation.getLocName(); String locAddress=defaultLocation.getLocAddress(); String
						locAddressName=defaultLocation.getLocAddressName(); String
								...
								<div id="member_info">
									<form action="<%=contextPath%>/update.me" method="post">
										<table id="member_table">
											<tr>
												<th>ID</th>
												<td><input type="text" class="form-control mb-2 mr-sm-2" name="memId"
											...
											<tr>
												<th>마케팅 선택 동의 사항</th>
												<td><input type="checkbox" name="adCheck" id="email" value="이메일"> <label
														for="email">이메일</label> <br> <input type="checkbox"
														name="adCheck" id="text" value="문자"> <label
