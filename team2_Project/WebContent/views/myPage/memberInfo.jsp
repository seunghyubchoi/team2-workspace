<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <body>
        <%@include file="../common/menubar.jsp" %>
            ...
            <div id="wrap">
                <div id="menu_list">
                    <div class="list_name"><a href="#">회원정보관리</a></div>
                    <div class="list_name"><a href="#">주문내역</a></div>
                    <div class="list_name"><a href="#">적립금내역</a></div>
                    <div class="list_name"><a href="#">좋아요</a></div>
                    <div class="list_name"><a href="#">팔로잉/팔로워</a></div>
                </div>
                <div id="menu_content">
