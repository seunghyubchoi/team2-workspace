	...
	<div id="content">
		...
		<form action="<%=contextPath%>/insert.co" method="post"
			...
			<img id="preview" style="width: 200px; height: 200px;"
				data-bs-toggle="modal" data-bs-target="#exampleModal"> <input
				type="file" onchange="readURL(this);" data-width="300"
			...
			<!-- Modal -->
			<div class="modal fade modal-dialog modal-xl" id="exampleModal"
			...
			<input name='tags' placeholder='태그를 입력하세용'>


			<br> <br> <br> <br> <input type="checkbox"
				required> 콘텐츠 활동 동의 (필수)
			<h5>
