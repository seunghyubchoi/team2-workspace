-- TABLE DROP
DROP TABLE TB_DTL_ORDER; -- 추가 드랍테이블
...
CREATE TABLE TB_PRODUCT (
	...
	CATEGORY_NO NUMBER	NOT NULL REFERENCES TB_CATEGORY, -- CATEGORY_NO2 -> CATEGORY_NO
...
CREATE TABLE TB_NOTICE (
    ...
    NOTICE_CONTENT VARCHAR2(4000) NOT NULL, -- VARCHAR2(2000) -> VARCHAR2(4000)
    NOTICE_DATE DATE DEFAULT SYSDATE NOT NULL,
    MANAGER_NO NUMBER NOT NULL REFERENCES TB_MANAGER,
    DEL_YN VARCHAR2(1) DEFAULT 'N' CHECK (DEL_YN IN('Y', 'N')) -- NOTICE_FILE 컬럼 삭제후/ DEL_YN추가
...
CREATE TABLE TB_ORDER (
	...
	ORDER_STATUS VARCHAR2(20) DEFAULT '상품준비중' NOT NULL,
...
CREATE TABLE TB_MILEAGE_HISTORY(
    ...
    MILEAGE VARCHAR2(10), -- 추가컬럼
    PRODUCT_NO NUMBER NOT NULL REFERENCES TB_PRODUCT, -- 추가 컬럼
    MEM_NO NUMBER NOT NULL REFERENCES TB_MEMBER -- 식별키로 변경
);
...
COMMENT ON COLUMN TB_ORDER.SAVE_MILEAGE IS '적립마일리지'; -- 추가코멘트
COMMENT ON COLUMN TB_ORDER.USE_MILEAGE IS '사용마일리지'; -- 추가코멘트

COMMENT ON COLUMN TB_DTL_ORDER.DTL_ORDER_NO IS '주문 상세번호';
COMMENT ON COLUMN TB_DTL_ORDER.PRODUCT_NO IS '상품번호';
COMMENT ON COLUMN TB_DTL_ORDER.ORDER_NO IS '주문번호';
COMMENT ON COLUMN TB_DTL_ORDER.DTL_SIZE IS '상품 사이즈';
COMMENT ON COLUMN TB_DTL_ORDER.DTL_QNT IS '상품 수량';
...
INSERT INTO TB_INSTA_IMAGE VALUES(SEQ_INSTA_IMAGE.NEXTVAL,'익명의 패션사진1','/resource/insta-image1.jpg','바뀐사진1');
INSERT INTO TB_INSTA_IMAGE VALUES(SEQ_INSTA_IMAGE.NEXTVAL,'익명의 패션사진2','/resource/insta-image2.jpg','바뀐사진2');
INSERT INTO TB_INSTA_IMAGE VALUES(SEQ_INSTA_IMAGE.NEXTVAL,'익명의 패션사진3','/resource/insta-image3.jpg','바뀐사진3');
INSERT INTO TB_INSTA_IMAGE VALUES(SEQ_INSTA_IMAGE.NEXTVAL,'익명의 패션사진4','/resource/insta-image4.jpg','바뀐사진4');
INSERT INTO TB_INSTA_IMAGE VALUES(SEQ_INSTA_IMAGE.NEXTVAL,'익명의 패션사진5','/resource/insta-image5.jpg','바뀐사진5');
...
INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,1,1,DEFAULT,' 배송완료',NULL,'박희연','01062612122','역삼 래미안 아파트','101동303호','06218',NULL,300,0);
INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,2,1,DEFAULT,' 배송완료',NULL,'이윤화','01064622323','역삼 래미안 아파트','103동503호','06218','부재시 문앞에 두고가주세요',300,0);
INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,3,2,DEFAULT,' 배송완료',NULL,'전혜정','01066632524','여의도 자이아파트','105동 809호','07324','경비실에 맡겨주세요',300,0);
INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,4,1,DEFAULT,' 배송완료',NULL,'정지용','01068642725','신길 목련아파트','101동 303호','07362',NULL,500,0);
INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,5,1,DEFAULT,' 배송완료',NULL,'최승협','01060652926','여의도 자이아파트','106동 1103호','07324',NULL,500,0);
...
INSERT INTO TB_MILEAGE_HISTORY VALUES(SEQ_MILEAGE_HISTORY.NEXTVAL,'사용',NULL,1,1);
INSERT INTO TB_MILEAGE_HISTORY VALUES(SEQ_MILEAGE_HISTORY.NEXTVAL,'사용',NULL,2,2);
INSERT INTO TB_MILEAGE_HISTORY VALUES(SEQ_MILEAGE_HISTORY.NEXTVAL,'적립',NULL,3,3);
INSERT INTO TB_MILEAGE_HISTORY VALUES(SEQ_MILEAGE_HISTORY.NEXTVAL,'적립',NULL,4,4);
INSERT INTO TB_MILEAGE_HISTORY VALUES(SEQ_MILEAGE_HISTORY.NEXTVAL,'적립',NULL,5,5);
