...
CREATE TABLE TB_INQUIRE (
    ...
    ANS_YN CHAR(1) DEFAULT 'N' CHECK(ANS_YN IN('Y','N')), -- 수정
    DEL_YN CHAR(1) DEFAULT 'N' CHECK(DEL_YN IN('Y','N')),
...
CREATE TABLE TB_ORDER (
	...
	RCP_MSG	VARCHAR2(50),
    -- OPTION_SIZE NUMBER NOT NULL REFERENCES TB_OPTION
    OPTION_SIZE VARCHAR2(5)
);
...
CREATE TABLE TB_MILEAGE_HISTORY(
    ...
    ORDER_NO NUMBER NOT NULL REFERENCES TB_ORDER, -- 추가 컬럼(수정)
...
COMMENT ON COLUMN TB_MILEAGE_HISTORY.ORDER_NO IS '주문번호';
...
COMMENT ON COLUMN TB_ORDER.OPTION_SIZE IS '옵션사이즈';
...
INSERT INTO TB_INSTAGRAM VALUES(SEQ_INSTAGRAM.NEXTVAL,'옷은 내가 제일 잘입어','#패션','INSTA01',NULL,3,2,SYSDATE);
INSERT INTO TB_INSTAGRAM VALUES(SEQ_INSTAGRAM.NEXTVAL,'인생패션입니다.','#인생','INSTA02',NULL,1,3,SYSDATE);
INSERT INTO TB_INSTAGRAM VALUES(SEQ_INSTAGRAM.NEXTVAL,'아~ 내 청춘이여','#청춘','INSTA03',NULL,2,4,SYSDATE);
INSERT INTO TB_INSTAGRAM VALUES(SEQ_INSTAGRAM.NEXTVAL,'내 옷 이쁘죠?','#내가최고','INSTA04',NULL,2,5,SYSDATE);
INSERT INTO TB_INSTAGRAM VALUES(SEQ_INSTAGRAM.NEXTVAL,'이쁜 연보라','#퍼플','INSTA05',NULL,4,1,SYSDATE);
...
INSERT INTO TB_OPTION VALUES(SEQ_OPTION.NEXTVAL, 'S', 10, 2);
INSERT INTO TB_OPTION VALUES(SEQ_OPTION.NEXTVAL, 'M', 15, 2);
INSERT INTO TB_OPTION VALUES(SEQ_OPTION.NEXTVAL, 'L', 13, 2);
INSERT INTO TB_OPTION VALUES(SEQ_OPTION.NEXTVAL, 'XL', 10, 2);
INSERT INTO TB_OPTION VALUES(SEQ_OPTION.NEXTVAL, 'FREE', 10, 5);

--INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,1,1,1,DEFAULT,' 배송완료',NULL,'박희연','01062612122','역삼 래미안 아파트','101동303호','06218',NULL,1);
--INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,2,1,1,DEFAULT,' 배송완료',NULL,'이윤화','01064622323','역삼 래미안 아파트','103동503호','06218','부재시 문앞에 두고가주세요',2);
--INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,3,1,2,DEFAULT,' 배송완료',NULL,'전혜정','01066632524','여의도 자이아파트','105동 809호','07324','경비실에 맡겨주세요',3);
--INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,4,3,1,DEFAULT,' 배송완료',NULL,'정지용','01068642725','신길 목련아파트','101동 303호','07362',NULL,4);
--INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,5,4,1,DEFAULT,' 배송완료',NULL,'최승협','01060652926','여의도 자이아파트','106동 1103호','07324',NULL,5);

INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,1,1,1,DEFAULT,' 배송완료',NULL,'박희연','01062612122','역삼 래미안 아파트','101동303호','06218',NULL,'S');
--INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,1,2,1,DEFAULT,' 배송완료',NULL,'박희연','01062612122','역삼 래미안 아파트','101동303호','06218',NULL,'M');

INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,2,1,1,DEFAULT,' 배송완료',NULL,'이윤화','01064622323','역삼 래미안 아파트','103동503호','06218','부재시 문앞에 두고가주세요','M');
INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,3,1,2,DEFAULT,' 배송완료',NULL,'전혜정','01066632524','여의도 자이아파트','105동 809호','07324','경비실에 맡겨주세요','L');
INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,4,3,1,DEFAULT,' 배송완료',NULL,'정지용','01068642725','신길 목련아파트','101동 303호','07362',NULL,'XL');
INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,5,4,1,DEFAULT,' 배송완료',NULL,'최승협','01060652926','여의도 자이아파트','106동 1103호','07324',NULL,'FREE');
...
--INSERT INTO TB_MILEAGE_HISTORY VALUES(SEQ_MILEAGE_HISTORY.NEXTVAL,'적립',300,2,1);
