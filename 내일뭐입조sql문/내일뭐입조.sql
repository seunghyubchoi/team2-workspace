...
UPDATE TB_INQUIRE SET
DEL_YN = 'N';

ALTER TABLE TB_INQUIRE MODIFY(QNA_VIEW_COUNT DEFAULT 0);

ALTER TABLE TB_INQUIRE DROP CONSTRAINT SYS_C007938;
commit;

ALTER TABLE TB_CATEGORY MODIFY (CATEGORY_NO NOT NULL);
COMMIT;
